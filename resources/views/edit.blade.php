    ...
    <div class="flex col justify-center items-center">
        <form class="p-[25px]" method="POST" action="/notes/{{$note->id}}">
            ...
            <div class="mb-[50px] flex flex-col">
                ...
                <textarea class="w-[50vw] border-2" name="content" id="content_textarea" cols="30" rows="10" placeholder="Something to remember...">
                    {{$note->content}}
                </textarea>
                @error('content')
                    <p class="text-red-700 text-xs mt-[5px]"> {{ $message }}</p>
            ...
            <div class="flex flex-row justify-between">
                ...
                <button class="text-[12px] px-[50px] py-[15px] border-2 border-green-500 hover:bg-green-500 hover:text-white font-bold flex items-center duration-300"> 
                    <span class="mr-[15px] material-symbols-outlined">
                        edit
                    </span>
                    Apply Changes
