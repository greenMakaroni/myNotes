...
@section('content')
  ...
  <form method="POST" action="/users" class="w-[100vw - 50px] pt-[50px] flex flex-col justify-center items-center">
    ...
    <div class="mb-6 mt-3">
      <button class="flex justify-center items-center text-[12px] w-[300px] px-[50px] py-[15px] border-2 border-green-500 hover:bg-green-500 hover:text-white font-bold flex items-center duration-300"> 
